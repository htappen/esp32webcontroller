...
static constexpr uint32_t kWsTimeoutMs = 1500;
static constexpr uint8_t kMaxControllerSlots = 4;
static constexpr uint32_t kControllerReconnectGraceMs = 5000;
...
static constexpr uint32_t kUsbLogBaudRate = 115200;
static constexpr int kUsbLogTxPin = 43;
static constexpr int kUsbLogRxPin = 44;
