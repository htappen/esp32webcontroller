...
NimBLEServer* BleCompositeHID::server() const
{
    return NimBLEDevice::getServer();
}

NimBLEAdvertising* BleCompositeHID::advertising() const
{
    NimBLEServer* pServer = server();
    return pServer ? pServer->getAdvertising() : nullptr;
}
